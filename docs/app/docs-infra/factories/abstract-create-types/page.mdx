...
- **[`loadPrecomputedTypesMeta`](../../pipeline/load-precomputed-types-meta/page.mdx)**: For build-time type extraction
...
At the fundamental level, the [`loadPrecomputedTypesMeta`](../../pipeline/load-precomputed-types-meta/page.mdx) function expects factory functions with these signatures:
...
For manual configuration, see the [`loadPrecomputedTypesMeta`](../../pipeline/load-precomputed-types-meta/page.mdx) documentation.
...
The [`loadPrecomputedTypesMeta`](../../pipeline/load-precomputed-types-meta/page.mdx) loader supports this pattern and will extract type information from the generic parameter, enabling:
...
- **[`loadPrecomputedTypesMeta`](../../pipeline/load-precomputed-types-meta/page.mdx)**: Build-time loader that extracts types
