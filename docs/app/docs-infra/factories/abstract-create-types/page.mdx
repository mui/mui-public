...
The [`loadPrecomputedTypesMeta`](../../pipeline/load-precomputed-types-meta/page.mdx) loader supports this pattern and will extract type information from the generic parameter.
