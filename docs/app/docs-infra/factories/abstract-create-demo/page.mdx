...
- **[`loadPrecomputedCodeHighlighter`](../../pipeline/load-precomputed-code-highlighter/page.mdx)**: For optimized loading

## Factory Function Requirements

At the fundamental level, the [`loadPrecomputedCodeHighlighter`](../../pipeline/load-precomputed-code-highlighter/page.mdx) function expects factory functions with these signatures:
...
To make global demo data work properly, use [`withDocsInfra`](../../pipeline/with-docs-infra/page.mdx) which automatically includes the demo-data patterns:
...
import { TypesAbstractCreateDemo } from './types';

<TypesAbstractCreateDemo />

[See Types](./types.md#abstractCreateDemo)
...
- **[`loadPrecomputedCodeHighlighter`](../../pipeline/load-precomputed-code-highlighter/page.mdx)**: Loader for optimized demos
