...
- **[`loadPrecomputedCodeHighlighterClient`](../../pipeline/load-precomputed-code-highlighter-client/page.mdx)**: For optimized loading with precomputed externals
...
For static code examples without live execution, use [`abstractCreateDemo`](../../factories/abstract-create-demo/page.mdx) instead.
