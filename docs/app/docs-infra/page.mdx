...
Then configure your Next.js app with [`withDocsInfra`](./functions/with-docs-infra/page.mdx):
...
- [Functions](./functions/page.mdx) - Loaders, transformers, and factory utilities
...
> [!WARNING]
> This is an internal project not intended for public use. No support or stability guarantees are provided. Use at your own risk.
