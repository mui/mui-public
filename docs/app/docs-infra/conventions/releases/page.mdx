...
5. Netlify PR preview retention we reduced to 90 days. It's a pain to do a bisection to find where the regression started on the docs. [https://github.com/mui/mui-public/issues/1016](https://github.com/mui/mui-public/issues/1016).
...
Why should references to the docs include the version in it? It acts as a permalink which mirrors this convention when discussing code on GitHub: [https://huonw.github.io/blog/2024/07/github-permalinks/](https://huonw.github.io/blog/2024/07/github-permalinks/)
