...
3. **Sync Types**: Runs [`syncTypes`](../../functions/sync-types/page.mdx) to regenerate type documentation
...
- [`syncTypes`](../../functions/sync-types/page.mdx) - Function that generates type documentation
