  ...
  webpack: (config, { buildId, dev, isServer, defaultLoaders, webpack }) => {
    config.module.rules.push({
      ...
      use: [
        ...
        '@mui/internal-docs-infra/pipeline/loadPrecomputedSitemap',
      ],
    });
...
const pages = Object.entries(sitemap.precompute.data).flatMap(
  ([_key, section]) => {
...
- [`createSitemap`](../../sitemap/page.mdx) - Factory function for creating sitemaps
