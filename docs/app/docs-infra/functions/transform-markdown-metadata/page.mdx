...
You can add status tags to index entries to highlight new, experimental, or noteworthy components. Tags appear directly after the component name for better visibility:
...
- [Button](#button) - [Full Docs](./button/page.mdx)
- [Checkbox](#checkbox) [New] - [Full Docs](./checkbox/page.mdx)
- [Input](#input) [Hot] [Beta] - [Full Docs](./input/page.mdx)
