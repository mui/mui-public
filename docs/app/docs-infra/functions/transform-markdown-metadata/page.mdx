...
- **User-controlled ordering**: Default marker `'This file is autogenerated, but the following order can be modified'` preserves the order you define in the editable section
