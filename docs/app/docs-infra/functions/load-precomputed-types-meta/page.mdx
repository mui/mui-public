...
The loader extracts comprehensive type information using [`typescript-api-extractor`](https://github.com/michaldudak/typescript-api-extractor/blob/main/README.md#output-format) and formats it with **HAST (Hypertext Abstract Syntax Tree) nodes** for syntax-highlighted rendering.
