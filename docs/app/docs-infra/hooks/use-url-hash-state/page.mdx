...
Use the [fragment delimiter convention](../../conventions/fragment-delimiters/page.mdx) for structured navigation.
...
import { TypesUseUrlHashState } from './types';

<TypesUseUrlHashState />
...
- [Fragment Delimiter Convention](../../conventions/fragment-delimiters/page.mdx) - Recommended pattern for hierarchical navigation
