...
import { DemoChunkStreamingBars } from './demos/streaming-bars';
import { DemoChunkLiveMetrics } from './demos/live-metrics';
import { DemoChunkLiveWaveform } from './demos/live-waveform';
import { DemoChunkEntirePlaintextProse } from './demos/prose-entire';
import { DemoChunkProgressiveProse } from './demos/prose-progressive';
...
For performance benchmarks of `useStream`, see the [Benchmarking useStream](./bench/page.mdx) page.
