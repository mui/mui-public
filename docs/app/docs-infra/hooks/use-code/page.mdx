...
collapsed-frame boundaries while editing, and moving past them (e.g. pressing
<kbd>↓</kbd> on the last visible line) automatically expands the block instead
of stranding the caret in hidden lines.
