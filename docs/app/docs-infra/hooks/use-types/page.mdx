...
import { DemoUseTypesDataAttrNamespace } from './demos/data-attr-namespace';

<DemoUseTypesDataAttrNamespace.Title />

This demo also publishes the metadata files as namespaces (`export * as ComponentDataAttributes from './ComponentDataAttributes'`). Each namespace is documented as a single re-export of the component's table, whatever name it is published under.

<DemoUseTypesDataAttrNamespace />

[See Demo](./demos/data-attr-namespace/)
