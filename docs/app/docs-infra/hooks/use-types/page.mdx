...
- **[`abstractCreateTypes`](../../factories/abstract-create-types/page.mdx)**: Factory functions where type processing happens
- **[`typesToJsx`](../../factories/abstract-create-types/page.mdx#typestojsx)**: Function that converts HAST to React nodes
- **[`loadPrecomputedTypesMeta`](../../pipeline/load-precomputed-types-meta/page.mdx)**: Build-time loader that extracts types as HAST
