...
test('use-types/data-attr-namespace renders its content', async ({ page }) => {
  ...
  // The data attribute is re-exported as a namespace, so seeing it in the table
  // confirms the component still found its constant group.
