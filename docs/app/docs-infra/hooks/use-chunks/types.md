...
[//]: types.ts '<-- Autogenerated By (do not edit the following markdown directly), run: pnpm docs:validate docs-infra/hooks/use-chunks'

## API Reference

### streamChunkSource

Drive any [`ChunkSource`](#chunksource) `mode` and yield an accumulating snapshot after
...
**useChunks Parameters:**

| Parameter | Type                     | Default | Description |
| :-------- | :----------------------- | :------ | :---------- |
| options   | `UseChunksOptions<P, O>` | -       | -           |

**useChunks Return Value:**

```tsx
type ReturnValue = UseChunksResult<P>;
```
...
**useChunksController Parameters:**

| Parameter | Type                         | Default | Description |
| :-------- | :--------------------------- | :------ | :---------- |
| options   | `UseChunksControllerOptions` | -       | -           |

**useChunksController Return Value:**

```tsx
type ReturnValue = UseChunksControllerResult;
```
...
A snapshot emitted by [`streamChunkSource`](#streamchunksource) after each chunk lands.
...
```typescript
type UseChunksControllerOptions = {
  /**
...
```typescript
type UseChunksControllerResult = {
  /**
...
Options for [`useChunks`](#usechunks).

```typescript
type UseChunksOptions<P, O> = {
  /**
...
Result of [`useChunks`](#usechunks).

```typescript
type UseChunksResult<P> = {
...
- `useChunks`: `useChunks`, `useChunksController`, `streamChunkSource`, `UseChunksOptions`, `UseChunksResult`, `ChunkSnapshot`, `UseChunksControllerOptions`, `UseChunksControllerResult`, `ChunkSource`, `ChunkUrlsResult`
- `useChunksController`: `useChunks`, `useChunksController`, `streamChunkSource`, `UseChunksOptions`, `UseChunksResult`, `ChunkSnapshot`, `UseChunksControllerOptions`, `UseChunksControllerResult`, `ChunkSource`, `ChunkUrlsResult`
- `streamChunkSource`: `useChunks`, `useChunksController`, `streamChunkSource`, `UseChunksOptions`, `UseChunksResult`, `ChunkSnapshot`, `UseChunksControllerOptions`, `UseChunksControllerResult`, `ChunkSource`, `ChunkUrlsResult`
