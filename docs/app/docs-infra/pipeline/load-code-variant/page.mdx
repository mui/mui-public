...
> See [Reconstructing the original file URL](../load-server-source/page.mdx#reconstructing-the-original-file-url).
...
Use `sourceEnhancers` to modify HAST nodes after parsing. Enhancers receive the parsed HAST root, any comments extracted from the source (via [`loadServerSource`](../load-server-source/page.mdx)), and the file name:
...
import { TypesLoadCodeVariant, TypesLoadCodeVariantAdditional } from './types';

### `loadCodeVariant`

<TypesLoadCodeVariant.loadCodeVariant />

[See Types](./types.md#loadCodeVariant)

### `loadCodeFallback`

<TypesLoadCodeVariant.loadCodeFallback />

[See Types](./types.md#loadCodeFallback)

### `parseCode`

<TypesLoadCodeVariant.parseCode />

[See Types](./types.md#parseCode)

### `flattenCodeVariant`

<TypesLoadCodeVariant.flattenCodeVariant />

[See Types](./types.md#flattenCodeVariant)

### `mergeCodeMetadata`

<TypesLoadCodeVariant.mergeCodeMetadata />

[See Types](./types.md#mergeCodeMetadata)

### `examineCodeVariant`

<TypesLoadCodeVariant.examineCodeVariant />

[See Types](./types.md#examineCodeVariant)

### `maybeCodeInitialData`

<TypesLoadCodeVariant.maybeCodeInitialData />

[See Types](./types.md#maybeCodeInitialData)

### `hasAllVariants`

<TypesLoadCodeVariant.hasAllVariants />

[See Types](./types.md#hasAllVariants)

### `enhanceCode`

<TypesLoadCodeVariant.enhanceCode />

[See Types](./types.md#enhanceCode)

### `applyCodeTransform`

<TypesLoadCodeVariant.applyCodeTransform />

[See Types](./types.md#applyCodeTransform)

### `addPathsToVariant`

<TypesLoadCodeVariant.addPathsToVariant />

[See Types](./types.md#addPathsToVariant)

## Additional Types

<TypesLoadCodeVariantAdditional />
