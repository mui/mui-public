...
- **Sitemap filtering**: Tags can be used with [`createSitemap`](../../factories/create-sitemap/page.mdx)'s `filter` option to conditionally exclude pages (e.g., hiding `[Private]` pages in production)
