...
import { TypesTransformHtmlCodeInlineHighlighted } from './types';

<TypesTransformHtmlCodeInlineHighlighted />
...
- [`formatProperties`](../load-precomputed-types/page.mdx#formatproperties) - Uses this for type highlighting
