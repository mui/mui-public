...
We can use the [Props Context Layering](../props-context-layering/page.mdx) pattern to abstract this complexity.

If you imagine the loading components following a pattern similar to this:
...
The user can write a content handler abstracted like this:
