...
- [`transformHtmlCodeBlock`](../../pipeline/transform-html-code-block/page.mdx): Processes `<pre><code>` blocks in HAST and precomputes syntax highlighting data
- [`transformHtmlCodeInline`](../../pipeline/transform-html-code-inline/page.mdx): Applies inline syntax highlighting to HAST
