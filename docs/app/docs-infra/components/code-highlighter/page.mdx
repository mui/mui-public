...
For code examples that you know will be above the fold, you can highlight it immediately.
It will only highlight the first 120 lines, or the focused region.
