...
import type { LoadVariantCode } from '@mui/internal-docs-infra/CodeHighlighter';
import Code from '../../../code-highlighter/demos/Code';
import { CodeHighlighter } from '@mui/internal-docs-infra/CodeHighlighter/CodeHighlighter';
