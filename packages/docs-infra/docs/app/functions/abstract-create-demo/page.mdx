...
The globals are automatically merged with demo code and made available through [`CodeExternalsContext`](../../components/code-externals-context/page.mdx) for live code execution.
