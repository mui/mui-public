...
export const snippet = createSnippet(import.meta.url, { A: externalFunctionA, B: externalFunctionB })
```
...
```ts
export const snippet = createSnippet(import.meta.url, { A: externalFunctionA, B: externalFunctionB }, { stripComments: true })
```
