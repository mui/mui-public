...
- [`loadPrecomputedCodeHighlighter`](./functions/loadPrecomputedCodeHighlighter/page.mdx) - Webpack loader for build-time demo optimization
- [`transformHtmlCode`](./functions/transformHtmlCode/page.mdx) - Plugin for transforming HTML code blocks into precomputed data structures
- [`transformMarkdownCodeVariants`](./functions/transformMarkdownCodeVariants/page.mdx) - Remark plugin for transforming markdown code blocks with variants into HTML structures
