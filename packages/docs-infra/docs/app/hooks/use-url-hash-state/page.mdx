  ...
  return (
    <nav>
      <button 
        ...
        className={hash === 'overview' ? 'active' : ''}
      >
        Overview
      </button>
      <button 
        onClick={() => setHash('details')}
        className={hash === 'details' ? 'active' : ''}
      >
        Details
      </button>
      <button onClick={() => setHash(null)}>
        Clear Hash
      </button>
    </nav>
  );
...
function NavigationExample() {
  ...
  return (
    <div>
      <button onClick={() => goToSection('intro', true)}>
        Go to Intro (new history entry)
      </button>
      <button onClick={() => goToSection('content')}>
...
function CustomParsingExample() {
  ...
  return (
    <div>
      ...
      <button onClick={() => setHash('intro')}>
        Set Intro (URL will be #section:intro)
      </button>
    </div>
  );
}
...
function ConditionalReadingExample() {
  ...
  return (
    <div>
      ...
      <button onClick={processInitialHash}>
...
function InteractionTrackingExample() {
  ...
  return (
    <div>
      ...
      <button onClick={() => handleUserClick('section1')}>
        Go to Section 1
      </button>
