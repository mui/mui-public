...
- [`useOnHydrate`](./use-on-hydrate/page.mdx): A hook for detecting React hydration completion and executing client-side callbacks.
- [`useOnIdle`](./use-on-idle/page.mdx): A hook for executing callbacks when the browser is idle, with configurable timeout.
