...
// TODO: Update old-format test inputs to new format once old format parsing is removed from the parser.
...
`;
  ...
  // TODO: Remove this describe block once old format parsing is removed from the parser.
...
- Button - ([Outline](#button), [Contents](./button/page.mdx), Private)
...
- Button - ([Outline](#button), [Contents](./button/page.mdx), Index)
...
- Button - ([Outline](#button), [Contents](./button/page.mdx), Public Index)
