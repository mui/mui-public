...
`;
      ...
      expect(result?.pages[0].private).toBe(true);
...
`;
      ...
      expect(result?.pages[0].private).toBeUndefined();
      expect(result?.pages[0].index).toBe(true);
    });
...
`;
  ...
  describe('private and index serialization', () => {
    ...
    it('should round-trip private and index fields', async () => {
      const original: PagesMetadata = {
        title: 'Components',
        pages: [
          {
      ...
      expect(parsed?.pages[0].private).toBe(true);
      expect(parsed?.pages[0].index).toBeUndefined();

      expect(parsed?.pages[1].private).toBe(true);
      expect(parsed?.pages[1].index).toBe(true);

      expect(parsed?.pages[2].private).toBeUndefined();
      expect(parsed?.pages[2].index).toBe(true);

      expect(parsed?.pages[3].private).toBeUndefined();
