...
`;
  ...
  it('should still parse the superseded link-definition comment idiom', async () => {
    const markdown = `# Components
...
`;
  ...
  it('should round-trip metadata through the emitted comment markers', async () => {
    const data: PagesMetadata = {
      title: 'Components',
      pages: [
        {
    ...
    const result = await markdownToMetadata(metadataToMarkdown(data));
