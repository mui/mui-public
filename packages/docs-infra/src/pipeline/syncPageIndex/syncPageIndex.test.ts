...
`;
  ...
  it('should correctly resolve index path from nested page structure', async () => {
    ...
    expect(content).toContain('Checkbox - ([Outline](#checkbox), [Contents](./checkbox/page.mdx))');
  ...
  it('should recursively update parent indexes when updateParents is true', async () => {
    ...
    expect(componentsContent).toContain('[Outline](#button)');
    ...
    expect(appContent).toContain('[Contents](./components/page.mdx)');
  });
  ...
  it('should respect filters when recursively updating parents', async () => {
    ...
    expect(appContent).not.toContain('[Outline](#components)');
  ...
  it('should not lose child pages when multiple concurrent updates occur', async () => {
    ...
    expect(appContent).toContain('[Outline](#overview)');
    expect(appContent).toContain('[Outline](#components)');
    expect(appContent).toContain('[Outline](#handbook)');
    expect(appContent).toContain('[Outline](#utils)');
  ...
  it('should handle metadata with parts array', async () => {
    ...
    expect(content).toMatchInlineSnapshot(`
      ...
      <details data-autogenerated-from="./alert-dialog">
...
`;
  ...
  it('should handle batch updates with parts and props', async () => {
    ...
    expect(content).toMatchInlineSnapshot(`
      ...
      <details data-autogenerated-from="./checkbox">
      ...
      <details data-autogenerated-from="./switch">
