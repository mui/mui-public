...
export function metadataToMarkdownAst(
  ...
  // Trim common prefixes, suffixes, and route groups from path for cleaner output
  const trimmedPath = path
    ?.replace(/^(src\/app\/|app\/)/, '')
    .replace(/\/page\.mdx$/, '')
    .replace(/\([^)]+\)\//g, '');
  const doNotEditComment = trimmedPath
    ? `This file is autogenerated, DO NOT EDIT AFTER THIS LINE, run: pnpm docs:validate ${trimmedPath}`
...
export function metadataToMarkdown(
  ...
  const trimmedPath = path
    ...
    .replace(/\/page\.mdx$/, '')
    .replace(/\([^)]+\)\//g, '');
  const doNotEditMarker = trimmedPath
    ? `[//]: # 'This file is autogenerated, DO NOT EDIT AFTER THIS LINE, run: pnpm docs:validate ${trimmedPath}'`
    : "[//]: # 'This file is autogenerated, DO NOT EDIT AFTER THIS LINE'";
