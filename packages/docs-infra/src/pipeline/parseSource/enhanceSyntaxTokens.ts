...
/**
 * Recursively walks HAST tree children, applying language-agnostic enhancements
...
/**
 * Enhances a syntax-highlighted HAST tree with additional `di-*` CSS classes
 * for fine-grained styling control. All enhancements are **additive** — existing
 ...
 */
export function enhanceSyntaxTokens(tree: Root, grammarScope: string): void {
