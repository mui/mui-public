  ...
  return (
    <button className="primary">Click me</button> // @highlight
      ...
      expect(result).toMatchInlineSnapshot(`
        ...
        </span><span class="frame" data-lined="" data-frame-type="highlighted" data-frame-indent="2"><span class="line" data-ln="3">    &#x3C;<span class="pl-ent">button</span> <span class="pl-e di-ak">className</span><span class="pl-k di-pu di-ae">=</span><span class="pl-s di-av"><span class="pl-pds">"</span>primary<span class="pl-pds">"</span></span>>Click me&#x3C;/<span class="pl-ent">button</span>></span>
...
const e = 5; // @highlight`,
      ...
      expect(result).toMatchInlineSnapshot(
        `
        "<span class="frame" data-lined="" data-frame-type="highlighted" data-frame-indent="0"><span class="line" data-ln="1"><span class="pl-k">const</span> <span class="pl-c1">a</span> <span class="pl-k di-pu">=</span> <span class="pl-c1 di-num">1</span>;</span>
        </span><span class="frame" data-lined=""><span class="line" data-ln="2"><span class="pl-k">const</span> <span class="pl-c1">b</span> <span class="pl-k di-pu">=</span> <span class="pl-c1 di-num">2</span>;</span>
        </span><span class="frame" data-lined="" data-frame-type="highlighted-unfocused" data-frame-indent="0"><span class="line" data-ln="3"><span class="pl-k">const</span> <span class="pl-c1">c</span> <span class="pl-k di-pu">=</span> <span class="pl-c1 di-num">3</span>;</span>
        </span><span class="frame" data-lined=""><span class="line" data-ln="4"><span class="pl-k">const</span> <span class="pl-c1">d</span> <span class="pl-k di-pu">=</span> <span class="pl-c1 di-num">4</span>;</span>
        </span>"
      `,
      );
    });
  ...
  return <div>{count}</div>;
      ...
      expect(result).toMatchInlineSnapshot(`
        ...
        </span><span class="frame" data-lined="" data-frame-type="highlighted" data-frame-indent="1" data-frame-description="We track state"><span class="line" data-ln="2">  <span class="pl-k">const</span> [<span class="pl-c1">count</span>, <span class="pl-c1">setCount</span>] <span class="pl-k di-pu">=</span> <span class="pl-en">useState</span>(<span class="pl-c1 di-num">0</span>);</span>
  ...
  return <a href={url}>Link</a>;
      ...
      expect(result).toMatchInlineSnapshot(`
        "<span class="frame" data-lined=""><span class="line" data-ln="1"><span class="pl-k">export</span> <span class="pl-k">default</span> <span class="pl-k">function</span> <span class="pl-en">Component</span>() {</span>
        </span><span class="frame" data-lined="" data-frame-type="highlighted" data-frame-indent="1"><span class="line" data-ln="2" data-hl="strong" data-hl-description="We must provide the URL" data-hl-position="single">  <span class="pl-k">const</span> <span class="pl-c1">url</span> <span class="pl-k di-pu">=</span> <span class="pl-en">getUrl</span>();</span>
        </span><span class="frame" data-lined=""><span class="line" data-ln="3">  <span class="pl-k">return</span> &#x3C;<span class="pl-ent">a</span> <span class="pl-e di-ak">href</span><span class="pl-k di-pu di-ae">=</span><span class="pl-pse">{</span><span class="pl-smi di-jv">url</span><span class="pl-pse">}</span>>Link&#x3C;/<span class="pl-ent">a</span>>;</span>
        <span class="line" data-ln="4">}</span></span>"
      `);
    });
  });
  ...
  return (
    ...
    it('should highlight JSX prop expressions', async () => {
      ...
      expect(result).toMatchInlineSnapshot(
        `"<span class="frame" data-lined="" data-frame-type="focus" data-frame-indent="0"><span class="line" data-ln="1">&#x3C;<span class="pl-c1 di-jsx">AlertDialog.Trigger</span> <mark><span class="pl-e di-ak">handle</span><span class="pl-k di-pu di-ae">=</span><span class="pl-pse">{</span><span class="pl-smi di-jv">demoAlertDialog</span><span class="pl-pse">}</span></mark>>Open&#x3C;/<span class="pl-c1 di-jsx">AlertDialog.Trigger</span>></span></span>"`,
      );
    });
...
<Button render={<div />} nativeButton={false}>`,
      ...
      expect(result).toMatchInlineSnapshot(
        `"<span class="frame" data-lined="" data-frame-type="focus" data-frame-indent="0"><span class="line" data-ln="1">&#x3C;<span class="pl-c1 di-jsx">Button</span> <span class="pl-e di-ak">render</span><span class="pl-k di-pu di-ae">=</span><span class="pl-pse">{</span>&#x3C;<span class="pl-ent">div</span> /><span class="pl-pse">}</span> <mark><span class="pl-e">nativeButton</span><span class="pl-k di-pu">=</span><span class="pl-pse">{</span><span class="pl-c1 di-bool">false</span><span class="pl-pse">}</span></mark>></span></span>"`,
      );
    });
  ...
  height: min(40px, var(--scroll-area-overflow-y-end, 40px)); /* @highlight-text ", 40px" */
    ...
    it('should highlight all occurrences across element boundaries', async () => {
      ...
      expect(result).toMatchInlineSnapshot(
        `"<span class="frame" data-lined="" data-frame-type="focus" data-frame-indent="0"><span class="line" data-ln="1">&#x3C;<span class="pl-c1 di-jsx">Input</span> <mark class="pl-e di-ak">value</mark><span class="pl-k di-pu di-ae">=</span><span class="pl-pse">{</span><span class="pl-smi di-jv">a</span><span class="pl-pse">}</span> /> &#x3C;<span class="pl-c1 di-jsx">Input</span> <mark class="pl-e di-ak">value</mark><span class="pl-k di-pu di-ae">=</span><span class="pl-pse">{</span><span class="pl-smi di-jv">b</span><span class="pl-pse">}</span> /> <span class="pl-c">// @highlight-text "<mark>value</mark>"</span></span></span>"`,
      );
    });
    ...
    it('should highlight both leaf and cross-element occurrences of the same text', async () => {
      ...
      expect(result).toMatchInlineSnapshot(
        `"<span class="frame" data-lined="" data-frame-type="focus" data-frame-indent="0"><span class="line" data-ln="1">&#x3C;<span class="pl-c1 di-jsx">Input</span> <mark class="pl-e di-ak">value</mark><span class="pl-k di-pu di-ae">=</span><span class="pl-pse">{</span><mark class="pl-smi di-jv">value</mark><span class="pl-pse">}</span> /></span></span>"`,
      );
    });
  });
...
const another = 99; // @highlight`,
      ...
      expect(result).toMatchInlineSnapshot(`
        "<span class="frame" data-lined="" data-frame-type="highlighted" data-frame-indent="0"><span class="line" data-ln="1"><span class="pl-k">const</span> <span class="pl-c1">value</span> <span class="pl-k di-pu">=</span> <span class="pl-c1 di-num">42</span>;</span>
        ...
        </span><span class="frame" data-lined="" data-frame-type="highlighted-unfocused" data-frame-indent="1"><span class="line" data-ln="3">  <span class="pl-k">const</span> <span class="pl-c1">x</span> <span class="pl-k di-pu">=</span> <span class="pl-c1 di-num">1</span>;</span>
        ...
        </span><span class="frame" data-lined=""><span class="line" data-ln="5">  <span class="pl-k">return</span> <span class="pl-smi">x</span> <span class="pl-k di-pu">+</span> <span class="pl-smi">y</span>;</span>
        <span class="line" data-ln="6">}</span>
        </span>"
      `);
    });
  ...
  return (
    <div>
      ...
      expect(result).toMatchInlineSnapshot(`
        ...
        </span><span class="frame" data-lined="" data-frame-type="highlighted" data-frame-indent="1" data-frame-description="We track state"><span class="line" data-ln="2">  <span class="pl-k">const</span> [<span class="pl-c1">data</span>, <span class="pl-c1">setData</span>] <span class="pl-k di-pu">=</span> <span class="pl-en">useState</span>([]);</span>
        ...
        </span><span class="frame" data-lined="" data-frame-type="highlighted-unfocused" data-frame-indent="3" data-frame-description="We render the main content"><span class="line" data-ln="6">      &#x3C;<span class="pl-c1 di-jsx">Chart</span> <span class="pl-e di-ak">data</span><span class="pl-k di-pu di-ae">=</span><span class="pl-pse">{</span><span class="pl-smi di-jv">data</span><span class="pl-pse">}</span> /></span>
