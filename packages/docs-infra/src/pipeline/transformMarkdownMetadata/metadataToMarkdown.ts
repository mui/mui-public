 ...
 */
export function metadataToMarkdownAst(data: PagesMetadata, editableMarker?: string): Root {
 ...
 */
export function metadataToMarkdown(data: PagesMetadata, editableMarker?: string): string {
